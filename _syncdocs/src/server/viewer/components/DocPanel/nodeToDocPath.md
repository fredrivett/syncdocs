...
dependencies:
  - path: src/server/viewer/components/DocPanel.tsx
    symbol: nodeToDocPath
    hash: f5a262a430b42007316ce0dbfe1d5de568e2d0b5c80c51e259bd648849443c3d
---
...
| Symbol | File | Type |
|---|---|---|
| `DocPanel` | `src/server/viewer/components/DocPanel.tsx` | direct-call |
